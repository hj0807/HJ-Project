...
## 1. Mediator Pattern 
- 객체들이 서로 복잡한 연관 관계를 맺고 있을 때, 클래스끼리 서로 호출하는 방법을 피하고 이러한 상호 작용에 관한 행동을 **중재자 객체** 에서 정의하여 중재.
...
http://hmjo.tistory.com/156

http://www.dofactory.com/net/mediator-design-pattern - 외국 사이트 예제

http://akangels-textcube.blogspot.kr/2009/11/mediator-pattern.html 설명